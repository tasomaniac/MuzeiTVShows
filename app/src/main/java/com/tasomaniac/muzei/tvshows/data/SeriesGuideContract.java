...
import com.tasomaniac.muzei.tvshows.util.ParserUtils;
...
public class SeriesGuideContract {
    ...
    interface ShowsColumns {
        ...
        /**
         * Show status. Encoded as integer.
         */
    ...
    public static class Episodes implements EpisodesColumns, BaseColumns {
        ...
        public static final String SELECTION_UNWATCHED = Episodes.WATCHED + "=" + 0x0;

        public static final String SELECTION_UNWATCHED_OR_SKIPPED = Episodes.WATCHED + "!=" + 0x1;

        public static final String SELECTION_WATCHED = Episodes.WATCHED + "=" + 0x1;

        public static final String SELECTION_WATCHED_OR_SKIPPED = Episodes.WATCHED + "!=" + 0x0;
